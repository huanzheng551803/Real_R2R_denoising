...
from dng_opcode import parse_opcode_lists1 as parse_opcode_lists
from exif_data_formats import exif_formats
from exif_utils import parse_exif_tag, parse_exif, get_tag_values_from_ifds1 as get_tag_values_from_ifds
...
def get_metadata1(image_path):
    metadata = {}
    tags = image_path
    ifds = image_path['UnknownTags']
