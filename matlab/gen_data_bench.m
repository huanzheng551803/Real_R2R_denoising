mkdir('./srgb_bench/')
names = dir (['/home/huanzheng/Documents/others_work/denoising_data/sidd_train/SIDD_Benchmark_Data/**/*GT_RAW*.MAT']);
length = size(names);
addpath(genpath('/home/huanzheng/Documents/others_work/denoising_data/sidd_train/SIDD_Benchmark_Data/'))
disp(names)
...
for i = 1: length(1)
    ...
    imwrite(r2r1Srgb, fullfile('./srgb',strrep(gt_name, '.MAT','_srgb_r2r1_1.png')));
    r2r1Srgb = run_pipeline(noisyRAW-noise/2, metadata, 'normal', 'srgb');
    imwrite(r2r1Srgb, fullfile('./srgb',strrep(gt_name, '.MAT','_srgb_r2r2_1.png')));


    noise = normrnd(0,1,size(gtRAW,1),size(gtRAW,2)).*sqrt(sigma1);
    r2r1Srgb = run_pipeline(noisyRAW+noise*2, metadata, 'normal', 'srgb');
    imwrite(r2r1Srgb, fullfile('./srgb',strrep(gt_name, '.MAT','_srgb_r2r1_2.png')));
    r2r1Srgb = run_pipeline(noisyRAW-noise/2, metadata, 'normal', 'srgb');
    imwrite(r2r1Srgb, fullfile('./srgb',strrep(gt_name, '.MAT','_srgb_r2r2_2.png')));
